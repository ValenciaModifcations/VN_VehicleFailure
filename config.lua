cfg = {
	...
	damageFactorEngine = 18.1,					-- Sane values are 1 to 100. Higher values means more damage to vehicle. A good starting point is 10
	damageFactorBody = 20.1,					-- Sane values are 1 to 100. Higher values means more damage to vehicle. A good starting point is 10
	damageFactorPetrolTank = 65.0,				-- Sane values are 1 to 100. Higher values means more damage to vehicle. A good starting point is 64
	...
	weaponsDamageMultiplier = 0.175,			-- How much damage should the vehicle get from weapons fire. Range 0.0 to 10.0, where 0.0 is no damage and 10.0 is 10x damage. -1 = don't touch
	...
	sundayDriverAcceleratorCurve = 8.0,			-- The response curve to apply to the accelerator. Range 0.0 to 10.0. Higher values enables easier slow driving, meaning more pressure on the throttle is required to accelerate forward. Does nothing for keyboard drivers
...
repairCfg = {
	mechanics = {
		...
		{name="Mechanic", id=446, r=15.0, x=1774.0,  y=3333.0,  z=41.0},	-- Flywheels Sandy
		...
		{name="Mechanic", id=0,   r=25.0, x=725.0,   y=4181.0,  z=40.0}		-- Hidden Mechanic
	},
	...
	fixMessages = {
		...
		"You stroked the dash, it enjoyed the stroke and has turned on.."
	},
	fixMessageCount = 8,
